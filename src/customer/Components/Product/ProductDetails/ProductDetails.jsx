...
export default function ProductDetails() {
  ...
  return (
    <div className="bg-graym lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol
            role="list"
            className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 main-cta"
          >
        ...
        {/* product details */}
        <section className="grid grid-cols-1 gap-x-5 gap-y-10 lg:grid-cols-2 px-4 pt-10">
          {/* Image gallery */}
          <div className="flex flex-col items-center ">
            <div className=" overflow-hidden rounded-lg max-w-[60rem] max-h-[75rem]">
              <img
          ...
          {/* Product info */}
          <div className="lg:col-span-1 max-h-auto  max-w-2xlpx-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="heading-products">
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1  lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                <h3 className="product-detailsheading">
                  Highlights
                </h3>
        ...
        {/* <p className="pdp-discount-container">
                ...
                <div className="pdp-mrp-verbiage" tabindex="0">
                  ...
                  <div>
                    ...
                    <span className="pdp-mrp-verbiage-amt">Rs.699</span>
                  </div>
                  <div>(Incl. of all taxes)</div>
                  <hr />
                  <div>
                    Discount<span className="pdp-mrp-verbiage-amt">54% OFF</span>
                  </div>
                  <div>
                    <b>Selling Price</b>
                    <span className="pdp-mrp-verbiage-amt">Rs. 321</span>
                  </div>
                  <div >(Incl. of all taxes)</div>
                </div>
                ...
                <span className="pdp-discount">(54% OFF)</span>
              </p> */}
        ...
        <section className=" pt-10">
          <h1 className="mainheading">Similer Products</h1>
